...
<head>
    ...
    <title>Construtora Sdantas</title>
	...
	<!-- <section class="top_header_area">
	    <div class="container">
            <ul class="nav navbar-nav top_nav">
                <li><a hsref="#"><i class="fa fa-phone"></i>+1 (168) 314 5016</a></li>
        ...
        <div class="slider_inner">
            <div data-thumb="images/slider-1.jpg" data-src="images/slider-1.jpg">
                <div class="camera_caption">
                   <div class="container">
                        <h5 class=" wow fadeInUp animated">SEJA BEM-VINDO A</h5>
                        <h3 class=" wow fadeInUp animated" data-wow-delay="0.5s">SDANTAS</h3>
                        <p class=" wow fadeInUp animated" data-wow-delay="0.8s">NOSSA EQUIPE DE PROFISSIONAIS IRÁ AJUDÁ-LO A TRANSFORMAR SUA CASA OU APARTAMENTO DOS SEUS SONHOS EM REALIDADE RAPIDAMENTE.</p>
                        <a class=" wow fadeInUp animated" data-wow-delay="1s" href="#">ENTRE EM CONTATO</a>
                   </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row about_row">
                <div class="who_we_area col-md-7 col-sm-6">
                    ...
                    <p>Atuando desde 1981, a SDantas Empreendimentos Imobiliários Ltda – incorporadora e construtora – é uma empresa sinônimo de credibilidade na construção civil do Rio Grande do Norte. Sempre comprometida, temos a confiança dos nossos clientes, porque cumprimos rigorosamente os prazos de entrega das obras, assim como realizamos os serviços de manutenção quinquenal, isto é, manutenção até cinco anos após a obra concluída.</p>
                    <p>Nossa principal missão é satisfazer os clientes e reduzir ao máximo os custos de produção. Mantendo os profissionais qualificados que passam por constantes treinamentos de atualização e aprimoramento. As tendências do mercado imobiliário são observadas e seguidas, o que resulta em constantes investimentos visando uma maior qualidade nas obras e um atendimento cada vez mais dinâmico, personalizado, humano e ético.</p>
                    <a href="#" class="button_all">Contate Agora</a>
                </div>
            ...
            <div class="row construction_iner">
                ...
                <div class="col-md-4 col-sm-6 construction">
                   ...
                   <div class="cns-content">
                        ...
                        <a href="#">PLANEJAMENTO DE PROJETO</a>
                        <p>Lorem Ipsum is simply dummy text of the print-ing and typesetting industry. Lorem Ipsum has been the industry's standard dummy </p>
                   </div>
                </div>
                <div class="col-md-4 col-sm-6 construction">
            ...
            <div class="feature_row row">
                ...
                <div class="col-md-6 feature_content">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <a href="#">MELHOR SERVIÇO AO CLIENTE</a>
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting indus-try. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="footer_row row">
                <div class="col-md-3 col-sm-6 footer_about">
                    ...
                    <p>SDantas Empreendimentos Imobiliários Ltda, construtora genuinamente potiguar desde 1981 constrói com responsabilidade, qualidade e credibilidade no mercado</p>
                ...
                <div class="col-md-3 col-sm-6 footer_about">
                    ...
                    <address>
                        ...
                        <ul class="my_address">
                            <li><a href="#"><i class="fa fa-envelope" aria-hidden="true"></i>contato@sdantas.com.br</a></li>
                            <li><a href="#"><i class="fa fa-phone" aria-hidden="true"></i>+55 84 3206 - 6352</a></li>
                            <li><a href="#"><i class="fa fa-map-marker" aria-hidden="true"></i>R. Felipe Cortez, 1840 - Lagoa Nova <br> 59056-150 Natal - RN</a></li>
                        </ul>
                    </address>
                </div>
            </div>
